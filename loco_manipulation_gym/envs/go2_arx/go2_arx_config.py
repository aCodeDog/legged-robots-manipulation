...
import numpy as np
class Go2ArxRoughCfg( LeggedRobotCfg ):
    ...
    class control( LeggedRobotCfg.control ):
        # PD Drive parameters:
        control_type = 'P'
        stiffness = {'joint': 20.}  # [N*m/rad] inlcudes all joints
        damping = {'joint': 0.5}     # [N*m*s/rad] inlcudes all joints
    ...
    class normalization(LeggedRobotCfg.normalization):
        ...
        clip_actions = 100.
class Go2ArxRoughCfgPPO( LeggedRobotCfgPPO ):
